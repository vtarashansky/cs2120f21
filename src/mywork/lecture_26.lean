...
- domain of definition ---- All elements in set of α
- domain                     -------- All elemments of α in relation 
- co-domain                ------------ All elements in set of β
- range                    ------------All elements of β in the relation
